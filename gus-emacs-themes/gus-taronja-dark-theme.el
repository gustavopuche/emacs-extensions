;;; tema-gus-taronja-dark-theme.el --- gus-taronja-dark-theme
...
(deftheme gus-taronja-dark
  "gus-taronja-dark theme")
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(default ((,class (:background ,background :foreground ,"#eeeeee"))))
...
(provide-theme 'gus-taronja-dark)

;;; gus-taronja-dark-theme.el ends here
