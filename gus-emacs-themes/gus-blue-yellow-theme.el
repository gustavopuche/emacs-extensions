...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(default ((t (:background "DodgerBlue" :foreground "#eeeeee" :family "CPMono_v07 Black" :weight light :height 98))))
   ...
   `(show-paren-match ((t (:bold t :foreground ,black :weight bold))))
