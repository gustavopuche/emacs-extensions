;;; tema-gus-orange-yellow.el --- gus-orange-yellow-theme
...
(deftheme gus-orange-yellow
  "gus-orange-yellow theme")
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   '(default ((t (:background "#ff9662" :foreground "#eeeeee" :family "CPMono_v07 Black" :weight light :height 98))))
...
(provide-theme 'gus-orange-yellow)
