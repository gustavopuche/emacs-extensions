;;; gus-yellow-theme.el --- yellow theme

;; Copyright (C) 2026 by Gustavo Puche
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (comment "light slate gray")
       (constant "medium slate blue")
       (coral "coral")
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:bold t :background ,blue :foreground ,background))))
   `(text-cursor ((t (:bold t :background ,blue :foreground ,background))))
   `(border ((t (:foregound "black"))))
   `(region ((,class (:foreground ,selection :background ,selection))))
   ...
   `(region ((t (:foreground ,selection :inverse-video t))))
   ...
   `(font-lock-comment-face ((t (:bold t :foreground ,comment))))
   `(font-lock-constant-face ((t (:bold t :foreground ,constant))))
   ...
   `(highlight-numbers-number ((t (:bold t :foreground ,numbers))))
   ...
   `(lsp-face-highlight-read ((,class (:foreground ,white :background ,green))))
   `(lsp-face-highlight-write ((,class (:foreground ,white :background ,red))))
   `(lsp-face-highlight-textual ((,class (:foreground ,white :background ,blue))))
...
(provide-theme `gus-yellow)

;;; gus-yellow-theme.el ends here
