...
(define-minor-mode doxy-graph-mode
  ...
  :keymap  doxy-graph-mode-map
	(define-key doxy-graph-mode-map (kbd "<M-s-f1>") 'doxy-graph-open-call-graph)
	(define-key doxy-graph-mode-map (kbd "<M-s-f2>") 'doxy-graph-open-inverted-call-graph)
	(define-key doxy-graph-mode-map (kbd "<M-s-f3>") 'doxy-graph-open-cpp-class-call-graph)
	(define-key doxy-graph-mode-map (kbd "<M-s-f4>") 'doxy-graph-open-cpp-class-inverted-call-graph))
